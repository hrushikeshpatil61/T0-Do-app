            ...
            delete_button.setOnClickListener{
                ...
                GlobalScope.launch {
                    database.dao().deleteTask(
                        Entity(pos+1,create_title.getText().toString(),create_priority.getText().toString())
                    )
                }
                my_Intent()
            }
            update_button.setOnClickListener{
                DataObject.updateData(pos,create_title.getText().toString(),create_priority.getText().toString())
                GlobalScope.launch {
